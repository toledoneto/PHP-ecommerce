...
<script type="text/javascript">PagSeguroDirectPayment.setSessionId('<?php echo htmlspecialchars( $pagseguro["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>');</script>
        ...
        PagSeguroDirectPayment.getPaymentMethods({
            ...
            success: function(response) {
                ...
                $.each(response.paymentMethods.ONLINE_DEBIT.options, function(index, option){
                    ...
                    //colocando os Tpls nos locais corretos
                    $("#tab-debito .contents").append(tplDebit({

                        //passando os valores exigidos pelo tpl. Estão disponíveis na respostas do pagseguro
                        value:option.name,
                ...
                // escondendo a animação de carregando e exibindo as opç para o user
                $('#loading').hide();

                // deixando a opç de boleto marcada por default
                $('#tabs-methods .nav-link:first').tab('show');

                // moostrando paines com formas de pgto
